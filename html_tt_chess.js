...
var ATTR_DIR			= "dir";				//"up", "down"
var VALUE_DIR_UP	= "up";
var VALUE_DIR_DOWN		= "down";
...
var MERIDA_COORD_U_COLS 				= 'abcdefgh';
var MERIDA_COORD_D_COLS 				= 'hgfedcba';
var MERIDA_COORD_U_ROWS 				= '8<br/>7<br/>6<br/>5<br/>4<br/>3<br/>2<br/>1<br/>';
var MERIDA_COORD_D_ROWS 				= '1<br/>2<br/>3<br/>4<br/>5<br/>6<br/>7<br/>8<br/>';
...
var MERIDA_FRAME_D_BOTTOM_U_COORD 	= '\uE348\uE349\uE34A\uE34B\uE34C\uE34D\uE34E\uE34F';
var MERIDA_FRAME_D_BOTTOM_D_COORD 	= '\uE34F\uE34E\uE34D\uE34C\uE34B\uE34A\uE349\uE348';
...
var MERIDA_FRAME_D_TOP_U_COORD 		= '\uE358\uE359\uE35A\uE35B\uE35C\uE35D\uE35E\uE35F'
var MERIDA_FRAME_D_TOP_D_COORD 		= '\uE35F\uE35E\uE35D\uE35C\uE35B\uE35A\uE359\uE358'

var MERIDA_FRAME_S_BOTTOM 			= '\uE306\uE306\uE306\uE306\uE306\uE306\uE306\uE306';
var MERIDA_FRAME_S_BOTTOM_U_COORD 	= '\uE318\uE319\uE31A\uE31B\uE31C\uE31D\uE31E\uE31F';
var MERIDA_FRAME_S_BOTTOM_D_COORD 	= '\uE31F\uE31E\uE31D\uE31C\uE31B\uE31A\uE319\uE318';
...
var MERIDA_FRAME_S_TOP_U_COORD 		= '\uE328\uE329\uE32A\uE32B\uE32C\uE32D\uE32E\uE32F'
var MERIDA_FRAME_S_TOP_D_COORD 		= '\uE32F\uE32E\uE32D\uE32C\uE32B\uE32A\uE329\uE328'
...
/* My Board object */
function ChessBoard(_fenCode,_attrBorder,_colorMode,_attrStyle,_attrClass,_boardDir)
{
	...
	this.parseFen = function()
	{
		...
		var flatFenCode = this.fenCode.replace(/\(|\)/g,"").split("/");
	...
	this.genColorHTML = function()
	{
        ...
        var coord_cols = this.boardDir?MERIDA_COORD_U_COLS:MERIDA_COORD_D_COLS;
        var coord_rows = this.boardDir?MERIDA_COORD_U_ROWS:MERIDA_COORD_D_ROWS;
	    if(this.isCoordShownTop)
	    {
	    	generatedHTML+='<tr>';
	    	generatedHTML+=(this.isCoordShownLeft || this.isCoordPadded ? "<td>&nbsp;</td>" : "") +
	    	            '<td class="cols">' + coord_cols.substr(this.coordOriginCol,this.colCount) + '</td>' +
	    ...
	    if(this.isCoordShownLeft)
	    {
	    	...
	    	generatedHTML+=coord_rows.substr((8-this.coordOriginRow-this.rowCount)*6,this.rowCount*6);
	    	generatedHTML+='</td>';
	    }
		else if(this.isCoordPadded)
		{
	    ...
	    {
                var row = this.boardDir ? r : (this.rowCount-1) - r;
                var isALightSquare 	= (row+isTopLeftSquareLight)&1 ? !this.boardDir : this.boardDir;
	        ...
	        for(c=0;c<inputRow.length;c++)
	    	{
                var col = this.boardDir ? c : (inputRow.length-1) - c;
	...
	this.genBWHTML = function()
	{
		...
		if(this.isBorderStyleSimple)
		{
			boardTop = this.isCoordShownTop
							? (this.isBorderShownTop ? (this.boardDir?MERIDA_FRAME_S_TOP_U_COORD:MERIDA_FRAME_S_TOP_D_COORD) : MERIDA_FRAME_COLS)
			...
			boardBottom = this.isCoordShownBottom
							? (this.isBorderShownBottom ? (this.boardDir?MERIDA_FRAME_S_BOTTOM_U_COORD:MERIDA_FRAME_S_BOTTOM_D_COORD) : MERIDA_FRAME_COLS)
		...
		{
			boardTop = this.isCoordShownTop
							? (this.isBorderShownTop ? (this.boardDir?MERIDA_FRAME_D_TOP_U_COORD:MERIDA_FRAME_D_TOP_D_COORD) : MERIDA_FRAME_COLS)
			...
			boardBottom = this.isCoordShownBottom
							? (this.isBorderShownBottom ? (this.boardDir?MERIDA_FRAME_D_BOTTOM_U_COORD:MERIDA_FRAME_D_BOTTOM_D_COORD) : MERIDA_FRAME_COLS)
...
function parseChess()
{
	...
	for (idx=0; idx<chessElt.length;idx++)
	{
		...
		var attrDir	= (chessElt[idx].getAttribute(ATTR_DIR) != null) ? chessElt[idx].getAttribute(ATTR_DIR) == VALUE_DIR_UP : true;
		...
		var board = new ChessBoard(boardFenCode, attrBorder, attrMode, attrStyle, attrClass, attrDir);
